...
BTreeNodeHeader::BTreeNodeHeader(bool isLeaf, RangeOpCounter roc)
    : _tag(isLeaf ? Tag::Leaf : Tag::Inner), rangeOpCounter(roc), dataOffset(isLeaf ? pageSizeLeaf : pageSizeInner)
{
}
